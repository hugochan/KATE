...
def plot_info_retrieval(precisions, save_file):
    ...
    new_x = interpolate.interp1d(ticks, range(10))(ticks)
...
if __name__ == '__main__':
    ...
    precisions = {
        ...
        'KCAE': [(0.001, 0.5525515376816517), (0.002, 0.5193115434751102), (0.005, 0.47137925802291214), (0.01, 0.43054295771668777), (0.02, 0.3822269819860004), (0.05, 0.2993674187772409), (0.1, 0.22469482404106303), (0.2, 0.15533223879910296), (0.5, 0.08635640605621561), (1.0, 0.05050301672031405)]}
