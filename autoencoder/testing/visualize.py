...
def plot(x, y, x_label, y_label, save_file):
    ...
    plt.plot(new_x, y, linestyle='-', alpha=0.8, markersize=8, marker='p', color='b')
    plt.xlabel(x_label)
    plt.ylabel(y_label)
    plt.savefig(save_file)
    plt.show()
...
if __name__ == '__main__':
    ...
    # x = [20, 32, 64, 128, 256, 512]
    # y = [0.688, 0.734, 0.767, 0.795, 0.805, 0.824]
    # plot(x, y, 'Number of topics', 'Classification accuracy', sys.argv[1])

    # Effect of alpha and beta
    # x = [1, 3, 6, 9, 12]
    # y = [ 0.791, 0.789, 0.792, 0.796, 0.796]
    # plot(x, y, r'$\alpha & \beta$', 'Classification accuracy', sys.argv[1])

    # # Effect of k
    x = [8, 16, 32, 64, 96, 128]
    y = [ 0.787, 0.791,  0.795,  0.793, 0.792, 0.766]
